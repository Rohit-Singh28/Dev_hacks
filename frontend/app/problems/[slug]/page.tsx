...
import { LANGUAGE_DEFAULTS, DIFFICULTY_COLORS, VERDICT_COLORS, VERDICT_LABELS } from "@/lib/constants";
import CodeEditor from "@/components/CodeEditor";
import ResultsPanel from "@/components/ResultsPanel";
import type { Problem, Language, Verdict, SubmissionUpdate, TestCaseResult, Submission } from "@/lib/types";
                ...
                userSubmissions.map((s) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-xs text-zinc-500">{s.language}</span>
                    </div>

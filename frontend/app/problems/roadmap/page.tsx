          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2 px-3 py-1.5 bg-zinc-800 border border-zinc-700 rounded-lg text-sm">
                <span className="text-blue-400 font-medium">{userProgress.totalPoints}</span>
        ...
        <div className="relative">
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    >
                      {level.isCompleted && (
                        <svg className="w-full h-full p-1 text-white" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    >
                      ...
                      <div className="flex items-start gap-4 mb-4">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <h3 className={`text-lg font-semibold ${level.isUnlocked ? "text-white" : "text-zinc-500"}`}>
                            {level.name}
                          </h3>
                          <p className={`text-sm ${level.isUnlocked ? "text-zinc-400" : "text-zinc-600"}`}>
                            {level.description}
                          </p>
                        </div>
                        ...
                        {!level.isUnlocked && (
                          <div className="text-right shrink-0">
                            <div className="text-xs text-zinc-500">Unlock at</div>
                            <div className="text-sm font-medium text-zinc-400">{level.requiredPoints} pts</div>
                          </div>
                        )}
                      </div>
                          ...
                          <div className="flex items-center justify-between gap-4">
                            <div className="flex items-center gap-3 min-w-0">
                              ...
                              <div className="min-w-0">
                                <h4 className={`font-medium truncate ${problem.solved ? "text-emerald-300" : "text-white"}`}>
                                  {problem.title}
                                </h4>
                                <div className="flex items-center gap-2 text-xs">
                                  <span className="text-blue-400 font-medium">+{problem.points} pts</span>
                                  {problem.solved && <span className="text-emerald-400">Completed</span>}
                                </div>
                              </div>
                            </div>
                        ...
                        <div className="p-4 rounded-lg bg-zinc-800/20 border border-zinc-800/50">
                          <div className="flex items-center justify-center gap-2 text-zinc-500">
                            ...
                            <span className="text-sm">
                              Earn {level.requiredPoints - userProgress.totalPoints} more points to unlock
                            </span>
                          </div>
                        </div>
                      )}
                      ...
                      {level.isCompleted && (
                        <div className="mt-4 flex items-center gap-2">
                          <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-amber-500/10 border border-amber-500/30">
                            ...
                            <span className="text-sm text-amber-400 font-medium">{level.badge.name}</span>
                          </div>
                        </div>
                      )}
                    </div>
          ...
          <div className="flex justify-center mt-12">
            <div className="flex flex-col items-center gap-3 text-zinc-500">
              ...
              <span className="text-sm">Complete all levels to become a master!</span>
            </div>
          </div>
        </div>
      </main>
          ...
          >
            ...
            <div className="p-4 max-h-[70vh] overflow-y-auto">
              <div className="grid grid-cols-4 gap-3">
                {levels.map((level) => {
                  const isEarned = userProgress.earnedBadges.includes(level.badge.name);
                  return (
                    <div
                      key={level.id}
                    ...
                    >
                      <div
                        ...
                        style={isEarned ? { color: level.badge.color } : undefined}
                      >
                        {level.badge.icon}
                      </div>
            ...
            <div className="p-4 border-t border-zinc-800 bg-zinc-900/50">
              <div className="flex items-center justify-between text-sm">
                <span className="text-zinc-400">
                  {userProgress.earnedBadges.length} of {levels.length} badges earned
                </span>
